...
def load_hifigan_vocoder(ckpt_path, device="cpu"):
    ...
    # fold weight norm into plain conv weights (exact: w = g * v/||v||) and drop the
    # forward hooks -- the per-forward recompute is incompatible with ComfyUI/AIMDO
    # dynamic weight paging and is pure overhead at inference time.
